...
// Igor is my personal assistant. He collects information about the game to be run and
// compiled it in some source code file so it doesn't have to be read at run time. He's
// not very smart but he does his job well.
...
int main(int argc, char** args)
{
	...
	{
		printf("igor crawls the assets of a game and outputs source code containing information about the tree that can be compiled into the binary.\n");
		return 1;
	}

	if (!g_shell.GetCommandLineSwitchValue("-game"))
	{
		printf("igor: You must specify a game directory.\n");
		return 1;
	}

	if (!g_shell.GetCommandLineSwitchValue("-header"))
	{
		printf("igor: You must specify a header to write.\n");
		return 1;
	}

	if (!g_shell.GetCommandLineSwitchValue("-source"))
	{
		printf("igor: You must specify a source file to write.\n");
		return 1;
	}
	...
	{
		printf("igor: It seems that game directory doesn't exist.\n");
		return 1;
	}
	...
	header_text = "#pragma once\n\n// This file is automatically generated by igor DO NOT MODIFY!\n// Command line:";
	...
	{
		printf("igor: No asset files have changed. Skipping code generation.\n");
		return 0;
	}
	...
	if (!fp_header)
	{
		printf("igor: Couldn't open the header file specified.\n");
		return 1;
	}

	if (!fp_source)
	{
		printf("igor: Couldn't open the source file specified.\n");
		return 1;
	}
	...
	printf("igor: Assets source '%s' and header '%s' written successfully.\n", source, header);
